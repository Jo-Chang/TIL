...
-- 문제 2
/*
테이블 customers 에서 customerNumber , customerName , phone 필드의 
모든 데이터를 조회하시오.
*/
...
-- 문제 3
/*
테이블 employees 에서 firstName , lastName , email 필드의 
모든 데이터를 조회하시오.
...
-- 문제 5
/*
테이블 employees 에서 employeeNumber , lastName , firstName , officeCode , jobTitle 필드의 
모든 데이터를 조회하시오.
...
-- 문제 7
/*
테이블 customers 에서 customerNumber , country , contactFirstName 필드의 
모든 데이터를 조회하시오.
...
-- 문제 8
/*
테이블 products 에서 productCode , quantityInStock , buyPrice 
그리고 quantityInStock * buyPrice 필드의 모든 데이터를 조회하시오.
